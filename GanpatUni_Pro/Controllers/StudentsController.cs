...
namespace GanpatUni_Pro.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Student.Include(s => s.Departments).Include(s => s.Users);
        ...
        public async Task<IActionResult> Create([Bind("Student_Id,Enroll_No,Semester,Dept_Id,User_Id")] Student student)
        {
            ...
            ViewData["User_Id"] = new SelectList(_context.Userms, "User_id", "Address", student.User_Id);
            return View(student);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Student_Id,Enroll_No,Semester,Dept_Id,User_Id")] Student student)
        {
